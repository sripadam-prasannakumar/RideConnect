...
import { LogOut, LayoutDashboard, Wallet, History, User, Settings, ShieldCheck } from 'lucide-react';
    ...
    return (
        <aside className="w-64 h-screen flex-shrink-0 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-background-dark flex flex-col sticky top-0 left-0 z-50">
            ...
            <div className="p-4 border-t border-slate-200 dark:border-slate-800 space-y-4">
                <div className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-white/5 group hover:border-primary/30 transition-all">
