...
from ride.views import (
    ...
    RideStatusView, CalculateFareView,
...
urlpatterns = [
    ...
    path('api/calculate-fare/', CalculateFareView.as_view(), name='calculate_fare'),
    ...
    path('api/ride/<int:ride_id>/status/', RideStatusView.as_view(), name='ride_status'),
